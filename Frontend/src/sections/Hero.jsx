...
const Hero = () => {
  ...
  return (
    <>
      ...
      <div className='z-50 h-[80vh] md:h-fit mb-10 md:mb-0 relative md:absolute top-[15vh] md:top-[25vh] max-w-[1100px] w-full mx-auto flex flex-col md:flex-row justify-center items-center gap-4 lg:gap-[20px] px-2 md:px-0'>
